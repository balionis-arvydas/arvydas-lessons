...
openApiValidate {
    inputSpec.set("$projectDir/specs/dainius-lesson11-consumer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.dainius.lesson11.consumer.generated.api")
    modelPackage.set("com.balionis.dainius.lesson11.consumer.generated.model")
    ...
    violationRules {
        rule {
            ...
            excludes = listOf(
                ...
                "com.balionis.dainius.lesson11.consumer.generated.*",
                "com.balionis.dainius.lesson11.consumer.stream.mappers.impl.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.dainius.lesson11.consumer.Application")

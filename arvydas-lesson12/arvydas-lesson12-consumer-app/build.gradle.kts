...
openApiValidate {
    inputSpec.set("$projectDir/../arvydas-lesson12-consumer-api/src/main/resources/openapi/arvydas-lesson12-consumer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.arvydas.lesson12.consumer.generated.api")
    modelPackage.set("com.balionis.arvydas.lesson12.consumer.generated.model")
...
tasks.jacocoTestCoverageVerification {
    violationRules {
        rule {
            ...
            excludes = listOf(
                "com.balionis.arvydas.lesson12.consumer.Application",
                "com.balionis.arvydas.lesson12.consumer.configuration.*",
                "com.balionis.arvydas.lesson12.consumer.generated.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.arvydas.lesson12.consumer.Application")

...
openApiValidate {
    inputSpec.set("$projectDir/../arvydas-lesson12-producer-api/src/main/resources/openapi/arvydas-lesson12-producer-api.yaml")
}
...
tasks.jacocoTestCoverageVerification {
    violationRules {
        rule {
            ...
            excludes = listOf(
                "com.balionis.arvydas.lesson12.producer.Application",
                "com.balionis.arvydas.lesson12.producer.configuration.*",
                "com.balionis.arvydas.lesson12.producer.generated.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.arvydas.lesson12.producer.Application")

...
openApiValidate {
    inputSpec.set("$projectDir/src/main/resources/openapi/arvydas-lesson12-consumer-api.yaml")
}
...
openApiGenerate {
    ...
    invokerPackage.set("com.balionis.arvydas.lesson12.consumer.generated.invoker")

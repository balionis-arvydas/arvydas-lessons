...
openApiValidate {
    inputSpec.set("$projectDir/specs/dainius-lesson9-consumer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.dainius.lesson9.consumer.generated.api")
    modelPackage.set("com.balionis.dainius.lesson9.consumer.generated.model")
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.dainius.lesson9.consumer.Application")

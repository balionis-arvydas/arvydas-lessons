...
openApiValidate {
    inputSpec.set("$projectDir/specs/dainius-lesson11-producer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.dainius.lesson11.producer.generated.api")
    modelPackage.set("com.balionis.dainius.lesson11.producer.generated.model")
    ...
    violationRules {
        rule {
            ...
            excludes = listOf(
                ...
                "com.balionis.dainius.lesson11.producer.generated.*",
                "com.balionis.dainius.lesson11.producer.stream.mappers.impl.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.dainius.lesson11.producer.Application")

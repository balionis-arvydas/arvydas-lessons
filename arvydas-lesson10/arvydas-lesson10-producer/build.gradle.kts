...
openApiValidate {
    inputSpec.set("$projectDir/specs/arvydas-lesson10-producer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.arvydas.lesson10.producer.generated.api")
    modelPackage.set("com.balionis.arvydas.lesson10.producer.generated.model")
    ...
    violationRules {
        rule {
            ...
            excludes = listOf(
                ...
                "com.balionis.arvydas.lesson10.producer.generated.*",
                "com.balionis.arvydas.lesson10.producer.stream.mappers.impl.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.arvydas.lesson10.producer.Application")

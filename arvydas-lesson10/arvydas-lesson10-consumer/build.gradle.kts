...
dependencies {
    ...
    implementation(project(":arvydas-lesson10-avro"))
}

openApiValidate {
    inputSpec.set("$projectDir/specs/arvydas-lesson10-consumer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.arvydas.lesson10.consumer.generated.api")
    modelPackage.set("com.balionis.arvydas.lesson10.consumer.generated.model")
    ...
    violationRules {
        rule {
            ...
            excludes = listOf(
                ...
                "com.balionis.arvydas.lesson10.consumer.generated.*",
                "com.balionis.arvydas.lesson10.consumer.stream.mappers.impl.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.arvydas.lesson10.consumer.Application")

...
openApiValidate {
    inputSpec.set("$projectDir/specs/arvydas-lesson09-producer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.arvydas.lesson09.producer.generated.api")
    modelPackage.set("com.balionis.arvydas.lesson09.producer.generated.model")
...
tasks.jacocoTestCoverageVerification {
    violationRules {
        rule {
            ...
            excludes = listOf(
                "com.balionis.arvydas.lesson09.producer.Application",
                "com.balionis.arvydas.lesson09.producer.configuration.*",
                "com.balionis.arvydas.lesson09.producer.generated.*",
                "com.balionis.arvydas.lesson09.producer.stream.mappers.impl.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.arvydas.lesson09.producer.Application")

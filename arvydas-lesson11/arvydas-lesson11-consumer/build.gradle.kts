...
openApiValidate {
    inputSpec.set("$projectDir/specs/arvydas-lesson11-consumer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.arvydas.lesson11.consumer.generated.api")
    modelPackage.set("com.balionis.arvydas.lesson11.consumer.generated.model")
...
tasks.jacocoTestCoverageVerification {
    violationRules {
        rule {
            ...
            excludes = listOf(
                "com.balionis.arvydas.lesson11.consumer.Application",
                "com.balionis.arvydas.lesson11.consumer.configuration.*",
                "com.balionis.arvydas.lesson11.consumer.generated.*",
                "com.balionis.arvydas.lesson11.consumer.stream.mappers.impl.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.arvydas.lesson11.consumer.Application")

...
openApiValidate {
    inputSpec.set("$projectDir/specs/dainius-lesson9-producer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.dainius.lesson9.producer.generated.api")
    modelPackage.set("com.balionis.dainius.lesson9.producer.generated.model")
    ...
    violationRules {
        rule {
            ...
            excludes = listOf(
                ...
                "com.balionis.dainius.lesson9.producer.generated.*",
                "com.balionis.dainius.lesson9.producer.stream.mappers.impl.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.dainius.lesson9.producer.Application")

...
openApiValidate {
    inputSpec.set("$rootDir/specs/arvydas-lesson05-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.arvydas.lesson05.generated.api")
    modelPackage.set("com.balionis.arvydas.lesson05.generated.model")
...
tasks.jacocoTestCoverageVerification {
    violationRules {
        rule {
            ...
            excludes = listOf(
                "com.balionis.arvydas.lesson05.Application",
                "com.balionis.arvydas.lesson05.configuration.*",
                "com.balionis.arvydas.lesson05.generated.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.arvydas.lesson05.Application")

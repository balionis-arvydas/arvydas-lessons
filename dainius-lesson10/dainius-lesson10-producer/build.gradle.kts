...
openApiValidate {
    inputSpec.set("$projectDir/specs/dainius-lesson10-producer-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.dainius.lesson10.producer.generated.api")
    modelPackage.set("com.balionis.dainius.lesson10.producer.generated.model")
    ...
    violationRules {
        rule {
            ...
            excludes = listOf(
                ...
                "com.balionis.dainius.lesson10.producer.generated.*",
                "com.balionis.dainius.lesson10.producer.stream.mappers.impl.*"
            )
        }
    }
